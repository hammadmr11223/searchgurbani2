                                            ...
                                            <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'} ${parseInt(lineno) === parseInt(item.shabdlineID) && 'ang-itm-shabad'}`} >
                                                ...
                                                {isSocialShare ?
                                                    ...
                                                    <div className='socia-share' style={{ marginLeft: '600px' }}>
                                                        <ul>
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); router.push('/GGS/ang/' + `${item.pageID}` + '/line/' + `${item.lineID}`) }}>Ang View</button></li>
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); router.push('/GGS/verse/' + `${item.verseID}`, { state: { line: item.pagelineID } }) }}>Verse View</button></li>
                                                        </ul>
                                                        <ul>
                                                            <li>
