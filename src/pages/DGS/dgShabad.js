                                            ...
                                            />}
                                                ...
                                                {isSocialShare ?
                                                    ...
                                                    <div className='socia-share' style={{ marginLeft: '600px' }}> 
                                                        <ul>
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); router.push('/DGS/page/' + `${item.pageID}` + '/line/' + `${item.lineID}`) }}>Page View</button></li>
                                                            <li><button className='ang-btn'  onClick={(e) => { e.preventDefault(); router.push('/DGS/verse/' + `${item.verseID}`,{ state: { line: item.pagelineID }} )}}>Verse View</button></li>
                                                            <li>
