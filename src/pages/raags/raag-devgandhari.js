...
function Devghandhari() {
  ...
  const getData = async () => {
    await Axios.get(
      "https://backend.searchgurbani.com/api/meta?url=raags/raag-devgandhari"
    )
      .then((resData) => {
  ...
  const getAngByAngAudio = async () => {
    setLoader(true);
    await ApiHelper.get(API.getAngByAngAudio + "?path=raags/raag_devgandhari")
      .then((resData) => {
        setLoader(false);
                      ...
                      <div className="row ">
                        <div class="col-lg-12">
                          <div class="px-1 py-1 align-middle mt-0 dev-giri rag-common rewamp_wrap rewamp-head-centerss">
                            <h2>Gurbani Raag Devgandhari</h2>
                            <div className="d-flex justify-content-center">
                              <audio
                                src={
                                  "https://backend.searchgurbani.com/" +
                                  audioList
                                }
