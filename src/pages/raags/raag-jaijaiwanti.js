...
function Jaijaiwanti() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=raags/raag-jaijaiwanti')
            .then((resData) => {
    ...
    const getAngByAngAudio = async () => {
        setLoader(true)
        await ApiHelper.get(API.getAngByAngAudio + "?path=raags/raag_jaijaivanti")
            .then((resData) => {
                setLoader(false);
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Raag Jaijaivanti -: searchgurbani.com`}
                description={`Learn about Gurbani Raag Jaijaivanti- searchgurbani.com`}
                                            ...
                                            <div className="row ">
                                                <div class="col-lg-12">
                                                    <div class="px-1 py-1 align-middle mt-0 dev-giri rag-common rewamp_wrap rewamp-head-centerss">
                                                        <h2>Gurbani Raag Jaijaivanti</h2>
