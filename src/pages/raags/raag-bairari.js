...
function Berari() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=raags/raag-bairari')
            .then((resData) => {
    ...
    const getAngByAngAudio = async () => {
        setLoader(true)
        await ApiHelper.get(API.getAngByAngAudio + "?path=raags/raag_bairari" )
            .then((resData) => {
                setLoader(false);
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Raag Bairari -: searchgurbani.com`}
                description={`Learn about Gurbani Raag Bairari- searchgurbani.com`}
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="second-container intro-bkg">
                        ...
                        <div className="row ">
                            <div class="col-lg-12">
                                <div class="px-1 py-1 align-middle mt-0 dev-giri rag-common rewamp_wrap rewamp-head-centerss berari"> 
                                <h2>Gurbani Raag: Bairari</h2> 
