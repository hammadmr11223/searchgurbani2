...
function Gyand() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-gyand')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Gyand -: searchgurbani.com`}
                description={`Life Story of Bhatt Gyand - searchgurbani.com`}
