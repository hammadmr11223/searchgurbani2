...
function Balh() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-balh')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Balh -: searchgurbani.com`}
                description={`Life Story of Bhatt Balh - searchgurbani.com`}
