...
function Salh() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-salh')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Salh -: searchgurbani.com`}
                description={`Life Story of Bhatt Salh - searchgurbani.com`}
