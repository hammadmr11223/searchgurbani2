...
function Mathura() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-mathura')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Mathura -: searchgurbani.com`}
                description={`Life Story of Bhatt Mathura - searchgurbani.com`}
