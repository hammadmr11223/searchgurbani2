...
function Kalshar() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-kalshar')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Kalshar -: searchgurbani.com`}
                description={`Life Story of Bhatt Kalshar - searchgurbani.com`}
