...
function SattaBalwand() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/satta')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Satta & Balwand -: searchgurbani.com`}
                description={`Life Story of Satta - searchgurbani.com`}
