...
function Mardana() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/mardana')
            .then((resData) => {
                                                            ...
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: introData.html
                                                                        ?.replace(/src="assets\/img\/res\/Mardana\.jpg"/g, `src="${MardanaImage.src}"` )
                                                                }}
                                                            /> : null}
                                                    </div>
                                                </div>
