...
function Jalap() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-jalap')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Jalap -: searchgurbani.com`}
                description={`Life Story of Bhatt Jalap - searchgurbani.com`}
