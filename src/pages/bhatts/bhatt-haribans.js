...
function Haribans() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-haribans')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Haribans -: searchgurbani.com`}
                description={`Life Story of Bhatt Haribans - searchgurbani.com`}
