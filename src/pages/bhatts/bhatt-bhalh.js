...
function Bhalh() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-bhalh')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Bhalh -: searchgurbani.com`}
                description={`Life Story of Bhatt Bhalh - searchgurbani.com`}
