...
function Nalh() {
    ...
    const getIntro = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhatts/bhatt-nalh')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhatt Nalh -: searchgurbani.com`}
                description={`Life Story of Bhatt Nalh - searchgurbani.com`}
                        ...
                        <div className="row ">
                            <div className="col-lg-12">
                                <div className='container align-items-center d-flex justify-content-center advance-search intro-border mt-5'>
                                    <div className="px-1 py-1 align-middle  bgv-intro">
                                        <div className="second-container intro-bkg">
                                            <div className="row ">
                                                <div class="col-lg-12">
