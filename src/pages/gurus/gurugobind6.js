...
function GuruGobind6() {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru Gobind Singh Sahib Ji -6-: searchgurbani.com`}
                description={`Learn about life story of Guru Gobind Singh ji -6- searchgurbani.com`}
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/gobind12\.jpg"/g, `src="${gobind12.src}"` )
                                               .replace(/src="assets\/img\/res\/gobind4\.jpg"/g, `src="${gobind4.src}"` )
                                                .replace(/src="assets\/img\/res\/gobind17\.jpg"/g, `src="${gobind17.src}"` )
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/gurugobind5'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/gurugobind7'>Next</Link></div>
                        </div>
