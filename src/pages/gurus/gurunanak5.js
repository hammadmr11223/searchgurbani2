            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/gurunanak4'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/gurunanak6'>Next</Link></div>
                        </div>
                    </div>
                </div>
