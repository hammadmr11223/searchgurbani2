...
import angad5 from '../../assets/img/content/gangad5.jpg';
import angad2 from '../../assets/img/content/gangad2.jpg';
...
function GuruAngad3() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/guruangad3')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru  Angad Dev Ji -3-: searchgurbani.com `}
                description={`Learn about life story of Guru Angad Dev ji -3- searchgurbani.com`}
            ...
            <section className='section-1'>
                                ...
                                <div class="px-1 py-1 align-middle mt-0 akl-intro">  
                                  ...
                                  {/*  {datas ?
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                            ?.replace('src=\"assets\/img\/res\/gangad5.jpg\"', `src="${angad5}"`)
                                            .replace('src=\"assets\/img\/res\/gangad2.jpg\"', `src="${angad2}"`)}} 
                                        /> : null} */}
                                        {/*  {datas ?
                                        ...
                                        : null} */}
                                          ...
                                          <div className='dates-ram rewamp_wrap'
                                            dangerouslySetInnerHTML={{
                                              __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/gangad5\.jpg"/g, `src="${angad5.src}"`)
                                                .replace(/src="assets\/img\/res\/gangad2\.jpg"/g, `src="${angad2.src}"`)
                                            }}
                                          />
                                        : null}
                                </div>
                ...
                <div className='page-content right-algn-next'><Link href='/gurus/guruangad2'>Back</Link></div> */}
                    </div>
                </div>
