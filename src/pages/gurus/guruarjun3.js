...
import garjan5 from '@/assets/img/content/garjan5.jpg'
import garjan9 from '@/assets/img/content/garjan9.jpg';
...
function GuruArjan3() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/guruarjun3')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru Arjan Dev Ji -3-: searchgurbani.com `}
                description={`Learn about life story of Guru Arjan Dev ji -3 - searchgurbani.com`}
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                                    ...
                                    {datas ?
                                        < div className='dates'
                                            dangerouslySetInnerHTML={{
                                                __html: datas.html
                                                    ?.replace(/src="assets\/img\/res\/garjan5\.jpg"/g, `src="${garjan5.src}"`)
                                                    .replace(/src="assets\/img\/res\/garjan9\.jpg"/g, `src="${garjan9.src}"`)
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/guruarjun2'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/guruarjun4'>Next</Link></div>
                        </div>
                    </div>
                </div>               
