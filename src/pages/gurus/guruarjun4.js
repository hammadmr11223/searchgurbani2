...
import garjan7 from '@/assets/img/content/garjan7.jpg'
import garjan8 from '@/assets/img/content/garjan8.jpg';
...
function GuruArjan4() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/guruarjun4')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru Arjan Dev Ji -4-: searchgurbani.com `}
                description={`Learn about life story of Guru Arjan Dev ji -4 - searchgurbani.com`}
            ...
            <section className='section-1'>
                                    ...
                                    {datas ?
                                        < div className='dates'
                                            dangerouslySetInnerHTML={{
                                                __html: datas.html
                                                    ?.replace(/src="assets\/img\/res\/garjan7\.jpg"/g, `src="${garjan7.src}"`)
                                                    .replace(/src="assets\/img\/res\/garjan8\.jpg"/g, `src="${garjan8.src}"`)
                ...
                <div className='page-content right-algn-next'><Link href='/gurus/guruarjun3'>Back</Link></div>
                    </div>
                </div>               
