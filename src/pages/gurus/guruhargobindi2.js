            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/gharg2\.jpg"/g, `src="${gharg2.src}"`)
                                                .replace(/src="assets\/img\/res\/gharg3\.jpg"/g, `src="${gharg3.src}"`)
                                                .replace(/src="assets\/img\/res\/gharg6\.jpg"/g, `src="${gharg6.src}"`)
                    ...
                    <hr></hr>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/guruhargobindi'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/guruhargobindi3'>Next</Link></div>
                        </div>
                </div>
        </div>
