...
function GuruArjan2() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/guruarjun2')
            .then((resData) => {
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                        ...
                        <div className='container align-items-center d-flex justify-content-center advance-search intro-border mt-5'>
                            <div class="px-1 py-1 align-middle  bgv-intro">
                                <div class="px-1 py-1 align-middle mt-0 akl-intro">
                                  {/* <p class="no-top">Sri Guru Arjan Dev Ji </p>*/}
                                    <div className="row ">
                                    </div>
                                    ...
                                    {datas ?
                                        < div className='dates'
                                            dangerouslySetInnerHTML={{
                                                __html: datas.html
                                                    ?.replace(/src="assets\/img\/res\/garjan2\.jpg"/g, `src="${garjan2.src}"`)
                                                    .replace(/src="assets\/img\/res\/garjan1\.jpg"/g, `src="${garjan1.src}"`)
                                                    .replace(/src="assets\/img\/res\/garjan6\.jpg"/g, `src="${garjan6.src}"`)
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/guruarjun'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/guruarjun3'>Next</Link></div>
                        </div>
                    </div>
                </div>               
