            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/gobind21\.jpg"/g, `src="${gobind21.src}"` )
                                                .replace(/src="assets\/img\/res\/gobind25\.jpg"/g, `src="${gobind25.src}"` )
                                        }}
                                    /> : null}
                            </div>
                        </div>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/gurugobind4'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/gurugobind6'>Next</Link></div>
                        </div>
