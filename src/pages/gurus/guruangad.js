                                    ...
                                    <div className="row ">
                                        <div class="col-lg-2">
                                            <div className='nanak-img mt-2 mb-0 d-flex flex-column' align="center">
                                                <Image src={gurutwo} class="nanak-imgs" alt="Responsive image" />
                                            ...
                                            <div className='list-div'>
                                                <div className='row'>
                                                    ...
                                                    <ul className='first-list'>
                                                        <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruangad'>GURU ANGAD IN SECLUSION</Link></li>
                                                        <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruangad'>EMPEROR HUMAYUN COMES TO THE GURU</Link></li>
                                                        <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruangad2'>GURMUKHI SCRIPT</Link></li>

                                                        <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruangad2'>BABA AMAR DAS COMES TO GURU ANGAD</Link></li>

                                                        <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruangad3'>CITY OF GOINDWAL</Link></li>
                                                        <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruangad3'>GURU ANGAD AND TAPA </Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
{/* {datas?.html && (
  <>
    <div
      className="dates-ram rewamp_wrap"
      dangerouslySetInnerHTML={{
        __html: datas.html
          // Remove image tags entirely or replace them with placeholders
          .replace(/<img[^>]*>/g, ''),
      }}
    />
  
    <Image src={angad1} alt="Gangad1" width={1000} height={500} />
    <Image src={angad4} alt="Gangad4" width={1000} height={500} />
  </>
)} */}
                ...
                <div className='page-content right-algn-next'><Link href='/gurus/guruangad2'>Next</Link></div>
