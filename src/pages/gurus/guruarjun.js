    ...
    return (
        <div>
            ...
            <section className='section-1'>
                                    ...
                                    <div className="row ">
                                        <div class="col-lg-2">
                                            <div className='nanak-img mt-2 mb-4' align="center">
                                                <Image src={guruArjan} class="nanak-imgs" alt="Responsive image" />
                                        ...
                                        <div className='list-div'>
                                            <div className='row'>
                                                ...
                                                <ul className='first-list'>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun'>MASAND SYSTEM</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun'>COMPLETION OF CONSTRUCTION WORK</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun2'>ANIMOSITY OF PRITHI CHAND</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun2'>PREACHING TOURS OF GURU</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun3'>COMPILATION OF ADI GRANTH</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun3'>PRITHI CHAND'S JEALOUSY </Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun4'>MARTYRDOM OF GURU ARJAN</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruarjun4'>SALUTE TO THE MIGHTY KING </Link></li>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/garjan3\.jpg"/g, `src="${garjan3.src}"`)
                                                .replace(/src="assets\/img\/res\/garjan4\.jpg"/g, `src="${garjan4.src}"`)
                ...
                <div className='page-content right-algn-next'><Link href='/gurus/guruarjun2'>Next</Link></div>
                </div>
        </div>
