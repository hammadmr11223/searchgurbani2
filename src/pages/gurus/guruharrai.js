                                    ...
                                    <div className="row ">
                                        <div class="col-lg-2">
                                            <div className='nanak-img mt-2 mb-4' align="center">
                                                <Image src={guruHarRai} class="nanak-imgs" alt="Responsive image" />
                                        ...
                                        <div className='list-div'>
                                            <div className='row'>
                                                ...
                                                <ul className='first-list'>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruhargobindi'>GURU'S PREACHING TOURS:</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruhargobindi'>THE GURU, HIS SON RAM RAI AND MUGHAL EMPEROR:</Link></li>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/ghrai2\.jpg"/g, `src="${ghrai2.src}"`)
                                                .replace(/src="assets\/img\/res\/ghrai1\.jpg"/g, `src="${ghrai1.src}"`)
                                                .replace(/src="assets\/img\/res\/ghrai3\.jpg"/g, `src="${ghrai3.src}"`)
                                                .replace(/src="assets\/img\/res\/ghrai5\.jpg"/g, `src="${ghrai5.src}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
