                                    ...
                                    <div className="row ">
                                        <div class="col-lg-6">
                                            <div className='nanak-img mt-2 mb-4' align="center">
                                                <Image src={guruKrish} class="guru-imgs" alt="Responsive image" />
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/ghark2\.jpg"/g, `src="${ghark2.src}"`)
                                                .replace(/src="assets\/img\/res\/ghark1\.jpg"/g, `src="${ghark1.src}"`)
                                                .replace(/src="assets\/img\/res\/ghark3\.jpg"/g, `src="${ghark3.src}"`)
                                                .replace(/src="assets\/img\/res\/ghark4\.jpg"/g, `src="${ghark4.src}"`)
                                                .replace(/src="assets\/img\/res\/ghark5\.jpg"/g, `src="${ghark5.src}"`)
