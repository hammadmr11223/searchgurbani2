...
function GuruGobind3() {
  ...
  const getData = async () => {
    await Axios.get(
      "https://backend.searchgurbani.com/api/meta?url=gurus/gurugobind3"
    )
      .then((resData) => {
      ...
      <section className="section-1">
        ...
        <div className="Gurbani-Raags p-4">
          <div className="container">
                        ...
                        {datas ? (
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: datas.html
                                ?.replace(
                                  /src="assets\/img\/res\/gobind10\.jpg"/g,
                                  `src="${gobind10.src}"`
                                )
                                .replace(
                                  /src="assets\/img\/res\/gobind24\.jpg"/g,
                                  `src="${gobind24.src}"`
                                )
                                .replace(
                                  /src="assets\/img\/res\/gobind14\.jpg"/g,
                                  `src="${gobind14.src}"`
                                ),
                            }}
                          />
            ...
            <hr></hr>
            <div className="row">
              <div className="col-lg-4 page-content left-algn-next ">
                <Link href="/gurus">Index</Link>
              </div>
              <div className="col-lg-4 page-content center-algn-next">
                <Link href="/gurus/gurugobind2">Back</Link>
              </div>
              <div className="col-lg-4  page-content right-algn-next">
                <Link href="/gurus/gurugobind4">Next</Link>
              </div>
            </div>
          </div>
        </div>
