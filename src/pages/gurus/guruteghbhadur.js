    ...
    return (
        <div>
            ...
            <section className='section-1'>
                                    ...
                                    <div className="row ">
                                        <div class="col-lg-2">
                                            <div className='nanak-img mt-2 mb-4' align="center">
                                                <Image src={guruBaha} class="nanak-imgs" alt="Responsive image" />
                                        ...
                                        <div className='list-div'>
                                            <div className='row'>
                                                ...
                                                <ul className='first-list'>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>GURU VISITS AMRITSAR</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>FOUNDATION OF CITY OF ANANDPUR</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>GURU ON MISSIONARY TOUR</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>GURU AT KURUKSHETRA</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>GURU IN UTTAR PRADESH </Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>GURU IN BIHAR PROVINCE</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur'>GURU TO BENGAL</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur1'>BIRTH OF A SON </Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur1'>AURANGZEB'S CAMPAIGN OF RELIGIOUS PERSECUTION</Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur1'>KASHMIRI BRAHMANS COME TO GURU </Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur1'>GURU SUMMONED TO DELHI </Link></li>
                                                    <li className='fonts-colors'><Link className='fonts-colors' href='/gurus/guruteghbhadur1'>MARTYRDOM OF GURU TEGH BAHADUR</Link></li>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace(/src="assets\/img\/res\/makhanlubana\.jpg"/g, `src="${gtb.src}"`)
                                                .replace(/src="assets\/img\/res\/gtb3\.jpg"/g, `src="${gtb3.src}"`)
                                                .replace(/src="assets\/img\/res\/gtb1\.jpg"/g, `src="${gtb1.src}"`)
                                                 .replace(/src="assets\/img\/res\/gtb2\.jpg"/g, `src="${gtb2.src}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
                ...
                <div className='page-content right-algn-next'><Link href='/gurus/guruteghbhadur1'>Next</Link></div>
        </div>
