...
function GuruNanak6() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/gurunanak6')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru Nanak Dev Ji -6-: searchgurbani.com`}
                description={`Learn about life story of Guru Nanak Dev ji -6- searchgurbani.com`}
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/gurunanak5'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/gurunanak7'>Next</Link></div>
                        </div>
                    </div>
                </div>
