...
function GuruAmarDas2() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/guruamar2')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru  Amar Das Ji -2-: searchgurbani.com `}
                description={`Learn about life story of Guru Amar Das ji -2- searchgurbani.com`}
                    ...
                    <div className="row ">
                        ...
                        <div className='container align-items-center d-flex justify-content-center advance-search intro-border mt-5'>
                            <div class="px-1 py-1 align-middle mt-5 bgv-intro">
                                ...
                                {datas ?
                                        < div className='dates-stro px-1 py-1 '
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                            ?.replace(/src="assets\/img\/res\/gamar3\.jpg"/g, `src="${gamar3.src}"`)
                                            .replace(/src="assets\/img\/res\/gamar4\.jpg"/g, `src="${gamar4.src}"`)
