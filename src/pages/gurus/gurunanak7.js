...
function GuruNanak7() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/gurunanak7')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru Nanak Dev Ji -7-: searchgurbani.com`}
                description={`Learn about life story of Guru Nanak Dev ji -7- searchgurbani.com`}
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link href='/gurus/gurunanak6'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link href='/gurus/gurunanak9'>Next</Link></div>
                        </div>
                    </div>
                </div>
