...
function GuruNanak10() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=gurus/gurunanak10')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Guru Nanak Dev Ji -10-: searchgurbani.com`}
                description={`Learn about life story of Guru Nanak Dev ji -10- searchgurbani.com`}
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                        ...
                        <div className='page-content right-algn-next'><Link href='/gurus/gurunanak9'>Back</Link></div>
                    </div>
                </div>
