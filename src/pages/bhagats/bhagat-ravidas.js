...
import s_ravidas from '@/assets/img/content/s_ravidas.gif';
import ravidas from '@/assets/img/content/ravidas.jpg';
...
function Ravidas() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-ravidas')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Ravidas Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Ravidas Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/s_ravidas\.gif"/g, `src="${s_ravidas.src}"` )
                                                                        .replace(/src="assets\/img\/res\/ravidas\.jpg"/g, `src="${ravidas.src}"` )
