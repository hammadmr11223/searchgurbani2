...
import bhikhan1 from '@/assets/img/content/bhikhan1.jpg';
...
function Bhikhan() {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-bhikan')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Bhikhan Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Bhikhan Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/bhikhan1\.jpg"/g, `src="${bhikhan1.src}"` )
