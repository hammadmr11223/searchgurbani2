...
import sain from '@/assets/img/content/sain.jpg';
...
function Sain() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-sain')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Sain Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Sain Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/sain\.jpg"/g, `src="${sain.src}"` )
                                                                }}
                                                            /> : null}
