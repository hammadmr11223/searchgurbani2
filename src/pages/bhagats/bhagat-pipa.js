...
import pipa from '@/assets/img/content/pipa.jpg';
...
function Pipa() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-pipa')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Pipa Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Pipa Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/pipa\.jpg"/g, `src="${pipa.src}"` )
                                                                }}
                                                            /> : null}
