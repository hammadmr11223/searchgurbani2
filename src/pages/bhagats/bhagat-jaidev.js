...
import jaidev from '@/assets/img/content/jaidev.jpg';
...
function Jaidev() {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-jaidev')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Jaidev Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Jaidev Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/jaidev\.jpg"/g, `src="${jaidev.src}"` )
                                                                }}
                                                            /> : null}
