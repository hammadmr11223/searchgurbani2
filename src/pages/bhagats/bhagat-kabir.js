...
import s_kabir from '@/assets/img/content/s_kabir.gif';
import kabir from '@/assets/img/content/kabir.jpg';
...
function Kabir() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-kabir')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Kabir Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Kabir Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/s_kabir\.gif"/g, `src="${s_kabir.src}"` )
                                                                        .replace(/src="assets\/img\/res\/kabir\.jpg"/g, `src="${kabir.src}"` )
                                                                }}
                                                            /> : null}
