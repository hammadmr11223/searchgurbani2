...
import parmanand from '@/assets/img/content/parmanand.jpg';
...
function Parmanand() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-parmanand')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Parmanand Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Parmanand Ji  at  searchgurbani.com`}
                                            ...
                                            <div className="row ">
                                                <div class="col-lg-12">
                                                    <div class="px-1 py-1 align-middle mt-0 akl-intro rewamp_wrap">
                                                        {datas ?
                                                            < div className='static-page blq'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/res\/parmanand\.jpg"/g, `src="${parmanand.src}"` )
                                                                }}
                                                            /> : null}
