...
import s_trilochan from '@/assets/img/content/s_trilochan.gif';
import trilochan from '@/assets/img/content/trilochan.jpg';
...
function Trilochan() {
    ...
    const getData = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=bhagats/bhagat-trilochan')
            .then((resData) => {
    ...
    return (
        <div>
            <HelmetWrapper
                title={`Bhagat Trilochan Ji -: searchgurbani.com`}
                description={`Life Story of Bhagat Trilochan Ji  at  searchgurbani.com`}
                                                        ...
                                                        {datas ?
                                                            < div className='static-page'
                                                                dangerouslySetInnerHTML={{
                                                                    __html: datas.html
                                                                        ?.replace(/src="assets\/img\/s_trilochan\.gif"/g, `src="${s_trilochan.src}"` )
                                                                        .replace(/src="assets\/img\/trilochan\.jpg"/g, `src="${trilochan.src}"` )
                                                                }}
                                                            /> : null}
