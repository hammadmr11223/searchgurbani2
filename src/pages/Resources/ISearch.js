                                            ...
                                            <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                                ...
                                                {isSocialShare ?
                                                    ...
                                                    <div className='socia-share' style={{ marginLeft: '600px' }}> 
                                                        <ul>
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); router.push('/GGS/shabad/' + `${item.shabad_id}` + '/line/' + `${item.shabdlineID}`) }}>Shabad View</button></li>
                                                            <li><button className='ang-btn'  onClick={(e) => { e.preventDefault(); router.push('/GGS/verse/' + `${item.verseID}` )}}>Verse View</button></li>
                                                            <li>
