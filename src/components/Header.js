...
function Header(props) {
  ...
  useEffect(() => {
    ...
    } else if (path.startsWith('/sundar-gutka/baanis')) { 
        ...
        <Container>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <Nav.Link as={Link} className={pathname === '/Resources/Hukumnama' ? 'active' : ''} href="/Resources/Hukumnama/">Today's Hukumnama</Nav.Link>
            </Nav>
      ...
      <section className='sub-menu' >
        ...
        <Container>
          <ul className='d-flex sub-menu-wrapper' >
            ...
            <li>
              <NavDropdown title="Bhai Nand Lal" id="navbarScrollingDropdown">
                <NavDropdown.Item as={Link} className={pathname === '/BNL/ghazal' ? 'active' : ''} href="/BNL/ghazal">
                  Divan-e-Goya : Ghazals
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/quatrains' ? 'active' : ''} href="/BNL/quatrains">
                  Rubaayee
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/zindginama' ? 'active' : ''} href="/BNL/zindginama">
                  Zindginama
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/ganjnama' ? 'active' : ''} href="/BNL/ganjnama">
                  Ganjnama
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/jot-bikas' ? 'active' : ''} href="/BNL/jot-bikas">
                  Jot Bikas(Punjabi)
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/jot-bikas-persian' ? 'active' : ''} href="/BNL/jot-bikas-persian">
                  Jot Bikas(Persian)
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/rahitnama' ? 'active' : ''} href="/BNL/rahitnama">
                  Rahit Nama
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/tankahnama' ? 'active' : ''} href="/BNL/tankahnama">
                  Tankah Nama
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BNL/search' ? 'active' : ''} href="/BNL/bnlSearch">
            ...
            <li>
              <NavDropdown className="res-cushrefms" title="Sundar Gutka" id="navbarScrollingDropdown">
                <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka' ? 'active' : ''} href="/sundar-gutka">
                  Introduction
                </NavDropdown.Item>

                <NavDropdown title="Nitnem" className="second-level" id="navbarScrollingDropdown">
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/japji-sahib' ? 'active' : ''} href="/sundar-gutka/baanis/japji-sahib">Japji Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/jaap-sahib' ? 'active' : ''} href="/sundar-gutka/baanis/jaap-sahib">Jaap Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/tvai-prasadh-savaiye' ? 'active' : ''} href="/sundar-gutka/baanis/tvai-prasadh-savaiye">Tvai Prasadh Savaiye</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/chaupai-sahib' ? 'active' : ''} href="/sundar-gutka/baanis/chaupai-sahib">Chaupai Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/anand-sahib' ? 'active' : ''} href="/sundar-gutka/baanis/anand-sahib">Anand Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/rehraas-sahib' ? 'active' : ''} href="/sundar-gutka/baanis/rehraas-sahib">Rehraas Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/baanis/kirtan-sohila' ? 'active' : ''} href="/sundar-gutka/baanis/kirtan-sohila">Kirtan Sohila</NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Guru Granth Sahib" className="second-level" id="navbarScrollingDropdown">
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/anand-sahib-bhog' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/anand-sahib-bhog">Anand Sahib(Bhog)</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/aarti' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/aarti">Arti</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/laavan-anand-karaj' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/laavan-anand-karaj">Laavan(Anand Karaj)</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/asa-ki-vaar' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/asa-ki-vaar">Asa Ki Vaar</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/sukhmani-sahib' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/sukhmani-sahib">Sukhmani Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/sidh-gosht' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/sidh-gosht">Sidh Gosht</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/ramkali-sadh' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/ramkali-sadh">Ramkali Sadh</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/dhakanee-oankaar' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/dhakanee-oankaar">Dhakanee Oankaar</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/baavan-akhree' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/baavan-akhree">Baavan Akhree</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/shabad-hazare' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/shabad-hazare">Shabad Hazare</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/baarah-maaha' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/baarah-maaha">Baarah Maaha</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/sukhmana-sahib' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/sukhmana-sahib">Sukhmana Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/dukh-bhanjani-sahib' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/dukh-bhanjani-sahib">Dukh Bhanjani Sahib</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/salok-sehskritee' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/salok-sehskritee">Salok Sehskritee</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/gathaa' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/gathaa">Gathaa</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/phunhay-m5' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/phunhay-m5">Phunhay M:5</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/chaubolay-m5' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/chaubolay-m5">Chaubolay M:5</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/salok-kabeer-ji' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/salok-kabeer-ji">Salok Kabeer Ji</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/salok-farid-ji' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/salok-farid-ji">Salok Farid Ji</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/savaiye-m1' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/savaiye-m1">Savaiye M:1</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/savaiye-m2' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/savaiye-m2">Savaiye M:2</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/savaiye-m3' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/savaiye-m3">Savaiye M:3</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/savaiye-m4' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/savaiye-m4">Savaiye M:4</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/savaiye-m5' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/savaiye-m5">Savaiye M:5</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/GGS/baanis/salok-m9' ? 'active' : ''} href="/sundar-gutka/GGS/baanis/salok-m9">Salok M:9</NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Dasam Granth" className="second-level" id="navbarScrollingDropdown">
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/DS/baanis/akal-ustati' ? 'active' : ''} href="/sundar-gutka/DS/baanis/akal-ustati">Akal Ustati</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/DS/baanis/bachitar-natak' ? 'active' : ''} href="/sundar-gutka/DS/baanis/bachitar-natak">Bachitar Natak</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/DS/baanis/shabad-hazare-paatishahi-10' ? 'active' : ''} href="/sundar-gutka/DS/baanis/shabad-hazare-paatishahi-10">Shabad Hazare Paatishahi 10</NavDropdown.Item>
                  <NavDropdown.Item as={Link} className={pathname === '/sundar-gutka/DS/baanis/tvai-prasaadh-savaiye-dheenan-kee' ? 'active' : ''} href="/sundar-gutka/DS/baanis/tvai-prasaadh-savaiye-dheenan-kee">Tvai Prasaadh Savai'ye (Dheenan Kee)</NavDropdown.Item>
                </NavDropdown>
              </NavDropdown>
            ...
            <li>
              <NavDropdown className="res-customs" title="Resources" id="navbarScrollingDropdown">
                <NavDropdown title="Hukumnama" className="second-level" id="navbarScrollingDropdown">
                  <NavDropdown.Item as={Link} className={pathname === '/Resources/Hukumnama/HukumIndex' ? 'active' : ''} href="/Resources/Hukumnama/HukumIndex">Hukumnama Index</NavDropdown.Item>
                ...
                <NavDropdown.Item as={Link} className={pathname === '/Resources/SGGK/SGGKSearch' ? 'active' : ''} href="/Resources/SGGK/SGGKSearch">Sri Guru Granth Kosh</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/Resources/SGGSKhosh/Sggsk' ? 'active' : ''} href="/Resources/SGGSKhosh/Sggsk">SGGS Kosh</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/Resources/SNP/SNPrakash' ? 'active' : ''} href="/Resources/SNP/SNPrakash">Sri Nanak Prakash</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/Resources/SGPSG' ? 'active' : ''} href="/Resources/SGPSG">Sri Gur Pratap Suraj Granth</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/Resources/FWT' ? 'active' : ''} href="/Resources/FWT">Faridkot Wala Teeka</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/Resources/SGGD' ? 'active' : ''} href="/Resources/SGGD">Sri Guru Granth Darpan</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/Resources/Maansarovar' ? 'active' : ''} href="/Resources/Maansarovar">Maansarovar</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/gurus' ? 'active' : ''} href="/gurus">Guru Sahiban</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/bhagats' ? 'active' : ''} href="/bhagats">Bhagat Sahiban</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/bhatts' ? 'active' : ''} href="/bhatts">Bhatt Sahiban</NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/raags' ? 'active' : ''} href="/raags">Gurbani Raags</NavDropdown.Item>
